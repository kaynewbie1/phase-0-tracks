...
# they can change and modify instance variables
  def get_mad_at(reindeer_name)
    ...
    # research array builtin methods that will push an item in an array to the end
...
p first_santa.reindeer_ranking
...
100.times do ||
  ...
  santas << santa #pushing santa into santas array
  end
  santas.each do |santa|
    puts santa.gender, santa.age, santa.ethnicity
  end
